...
/**
 * Universal Icon component — uses mask-image to support currentColor inheritance.
 * This is a universal atom component with consistent styling across all usage contexts.
