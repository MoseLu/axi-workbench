...
> Workspace project dossier. Source of truth: `/Volumes/code/workspace/products/story-graph`.
> Section: reference / Partition: `products/`.

## Summary

Evidence-driven local novel relationship graph workbench with a Python pipeline, SQLite evidence store, and React/Vite viewer.
...
- Workspace entry: [`WORKSPACE_INDEX.md`](/Volumes/code/workspace/WORKSPACE_INDEX.md) — partition table row "Story Graph".
- Project root: `/Volumes/code/workspace/products/story-graph`
- Project `AGENTS.md`: `/Volumes/code/workspace/products/story-graph/AGENTS.md` (when present).
- Project `README.md`: `/Volumes/code/workspace/products/story-graph/README.md` (when present).
