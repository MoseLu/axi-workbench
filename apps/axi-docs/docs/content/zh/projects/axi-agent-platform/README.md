...
> Workspace project dossier. Source of truth: `/Volumes/code/workspace/projects/axi-agent`.
...
- Project root: `/Volumes/code/workspace/projects/axi-agent`
- Project `AGENTS.md`: `/Volumes/code/workspace/projects/axi-agent/AGENTS.md` (when present).
- Project `README.md`: `/Volumes/code/workspace/projects/axi-agent/README.md` (when present).
