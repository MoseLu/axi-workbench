...
# Sub2API Reference —— PRD 分片

> Sub2API Reference 在 Axi Docs 中的 PRD 分片。这*不是*项目自身的 PRD；它只记录 Axi Docs 呈现该项目时的自身需求。

## REQ-PROJ-SUB2API-REFERENCE-001

| 字段 | 值 |
| --- | --- |
| 需求 | 为 Sub2API Reference 维护一份可被发现的 Axi Docs 档案。 |
| 验收 | `docs/content/{en,zh}/projects/sub2api-reference/README.md, AGENTS.md, INDEX.md, TODO.md, MILESTONE.md, PRD.md, TDD.md` 均存在，且 frontmatter 有效。 |
...
| 验收 | `pnpm --dir app projects:check --project=sub2api-reference` 通过。 |
