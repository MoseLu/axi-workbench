...
# Axi Pet — Agent Contract

> This dossier is the Axi Docs agent contract for **Axi Pet** (workspace path: `/Volumes/code/workspace/projects/axi-pet`).
> It does not replace the project root `AGENTS.md`. The project root always wins for project-local rules; this file only documents how Axi Docs *presents* the project.

## Read Order

1. This file (dossier).
2. `docs/content/{en,zh}/projects/axi-pet/README.md` (dossier summary).
3. Project root `AGENTS.md` at `/Volumes/code/workspace/projects/axi-pet/AGENTS.md`.
4. Project root `README.md` at `/Volumes/code/workspace/projects/axi-pet/README.md`.

## Boundary

- Axi Docs treats this project as **read-only content source**.
- Axi Docs never edits files under `/Volumes/code/workspace/projects/axi-pet`.
