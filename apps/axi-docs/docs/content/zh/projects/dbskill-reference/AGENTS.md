...
# DBSkill Reference — Agent Contract

> This dossier is the Axi Docs agent contract for **DBSkill Reference** (workspace path: `/Volumes/code/workspace/references/dbskill`).
> It does not replace the project root `AGENTS.md`. The project root always wins for project-local rules; this file only documents how Axi Docs *presents* the project.

## Read Order

1. This file (dossier).
2. `docs/content/{en,zh}/projects/dbskill-reference/README.md` (dossier summary).
3. Project root `AGENTS.md` at `/Volumes/code/workspace/references/dbskill/AGENTS.md`.
4. Project root `README.md` at `/Volumes/code/workspace/references/dbskill/README.md`.

## Boundary

- Axi Docs treats this project as **read-only content source**.
- Axi Docs never edits files under `/Volumes/code/workspace/references/dbskill`.
