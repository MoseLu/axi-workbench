...
# Cockpit Tools Reference — SECURITY Mirror

> Mirror of the project root `SECURITY.md` at `/Volumes/code/workspace/references/cockpit-tools/SECURITY.md`.
...
- For full content, read the source at `/Volumes/code/workspace/references/cockpit-tools/SECURITY.md`.
