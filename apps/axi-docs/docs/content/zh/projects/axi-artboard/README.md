...
> Workspace project dossier. Source of truth: `/Volumes/code/workspace/products/axi-artboard`.
> Section: reference / Partition: `products/`.

## Summary

AxiomaticWorld artboard/canvas product. Feature stage: React 19 + Vite 8 + TypeScript with custom vite-plugin-source-attrs + OverlayCanvas (right-click pin + left-drag marquee) + window.__artboard.targets() debug API + ambient-language anchoring for agent iteration. First real feature shipped: agent-node-picker.
...
- Workspace entry: [`WORKSPACE_INDEX.md`](/Volumes/code/workspace/WORKSPACE_INDEX.md) — partition table row "Axi Artboard".
- Project root: `/Volumes/code/workspace/products/axi-artboard`
- Project `AGENTS.md`: `/Volumes/code/workspace/products/axi-artboard/AGENTS.md` (when present).
- Project `README.md`: `/Volumes/code/workspace/products/axi-artboard/README.md` (when present).
