...
> Workspace project dossier. Source of truth: `/Volumes/code/workspace/shared/axi-skills`.
> Section: shared / Partition: `shared/`.

## Summary

Shared version-controlled skill catalog for Codex, Claude, Cursor, MiniMax, and compatible Axi agent runtimes, with verifier-backed runtime and i18n contracts.
...
- Workspace entry: [`WORKSPACE_INDEX.md`](/Volumes/code/workspace/WORKSPACE_INDEX.md) — partition table row "Axi Skills".
- Project root: `/Volumes/code/workspace/shared/axi-skills`
- Project `AGENTS.md`: `/Volumes/code/workspace/shared/axi-skills/AGENTS.md` (when present).
- Project `README.md`: `/Volumes/code/workspace/shared/axi-skills/README.md` (when present).
