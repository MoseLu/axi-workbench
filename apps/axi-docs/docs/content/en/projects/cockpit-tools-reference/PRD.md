...
| Acceptance | `docs/content/{en,zh}/projects/cockpit-tools-reference/README.md, AGENTS.md, INDEX.md, TODO.md, MILESTONE.md, PRD.md, TDD.md` exist with valid frontmatter. |
