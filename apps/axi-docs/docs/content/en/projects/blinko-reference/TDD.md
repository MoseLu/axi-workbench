...
- `pnpm --dir app projects:check` walks `docs/content/{en,zh}/projects/blinko-reference/README.md, AGENTS.md, INDEX.md, TODO.md, MILESTONE.md, PRD.md, TDD.md` and asserts every expected piece exists with valid frontmatter.
