...
# Image2Prompt Reference — Dossier Index
...
- Other locale: `docs/content/zh/projects/image2prompt-reference/`
- Workspace entry: `/Volumes/code/workspace/references/image2prompt`
