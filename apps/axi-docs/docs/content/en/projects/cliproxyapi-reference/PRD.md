...
| Acceptance | `docs/content/{en,zh}/projects/cliproxyapi-reference/README.md, AGENTS.md, INDEX.md, TODO.md, MILESTONE.md, PRD.md, TDD.md` exist with valid frontmatter. |
