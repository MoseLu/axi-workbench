...
> This dossier is the Axi Docs agent contract for **Axi Docs** (workspace path: `/Volumes/code/workspace/projects/axi-workbench/apps/axi-docs`).
...
3. Project root `AGENTS.md` at `/Volumes/code/workspace/projects/axi-workbench/apps/axi-docs/AGENTS.md`.
4. Project root `README.md` at `/Volumes/code/workspace/projects/axi-workbench/apps/axi-docs/README.md`.

## Boundary

- Axi Docs treats this project as **read-only content source**.
- Axi Docs never edits files under `/Volumes/code/workspace/projects/axi-workbench/apps/axi-docs`.
