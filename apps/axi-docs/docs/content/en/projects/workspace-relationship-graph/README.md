...
> Workspace project dossier. Source of truth: `/Volumes/code/workspace/workspace.graph.json`.
> Section: shared / Partition: `workspace.graph.json/`.

## Summary

Machine-readable graph of project providers, consumers, contracts, startup profiles, health checks, and verification commands.
...
- Workspace entry: [`WORKSPACE_INDEX.md`](/Volumes/code/workspace/WORKSPACE_INDEX.md) — partition table row "Workspace Relationship Graph".
- Project root: `/Volumes/code/workspace/workspace.graph.json`
- Project `AGENTS.md`: `/Volumes/code/workspace/workspace.graph.json/AGENTS.md` (when present).
- Project `README.md`: `/Volumes/code/workspace/workspace.graph.json/README.md` (when present).

## Notes

Use before cross-project edits.
