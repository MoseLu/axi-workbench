# Axi Workspace Governance PRD

## Problem

Axi workspace governance repo for /Volumes/code/workspace
...
- Maintainers working inside `/Volumes/code/workspace/infra/axi-workspace-governance`.
