...
> 镜像说明：本文件为 `docs/state/TODO.md` 的中文镜像。源文件本身已使用中文，因此主体保持同构内容；请直接修改 `TODO.md` 后同步本文件。本仓库的任务 facade、方案库边界与 P0/P3 路线以源文件为准。
...
| 类别 | 文件 | 说明 |
|---|---|---|
| 当前架构 backlog | [`todo/01-current-architecture.md`](todo/01-current-architecture.md) | ZC-DOCS-001~005：handoff-first dossier、axi-rules 一级源、项目页 HANDOFF 卡片、MCP 接手工具、TODO 拆分 |
...
ZC-DOCS-001~005 已于 2026-06-11 实施完成（见 `todo/01-current-architecture.md`）。新 Agent 接手时应按以下顺序阅读：
