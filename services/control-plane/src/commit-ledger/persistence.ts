...
// ============================================================================
// TypeScript Interface Exports (for api-handlers.ts)
// ============================================================================

/**
 * Commit Ledger V1 Record
 */
export interface CommitLedgerV1 {
  ...
  verification?: {
    status?: 'verified' | 'partial' | 'unverified' | 'failed' | 'conflict' | 'unknown';
    commands?: string[];
    evidenceRefs?: string[];
    observedAt?: string;
  };
...
export interface ConflictResult {
  hasConflict: boolean;
  reason?: string;
  conflictType?: 'sha_mismatch' | 'verification_conflict' | 'source_conflict' | null;
}
