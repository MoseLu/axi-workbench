...
// brandLogoPNG is the exact Axi dango-family source asset. It is copied
// byte-for-byte from the selected seven-member family illustration so the
...
//
//go:embed assets/axi-workbench-dango-family.png
var brandLogoPNG []byte

var brandLogoDataURL = "data:image/png;base64," + base64.StdEncoding.EncodeToString(brandLogoPNG)

// BrandLogoInlineAsset returns a defensive copy of the exact dango-family
// brand asset for a multipart/related email part.
func BrandLogoInlineAsset() InlineAsset {
	return InlineAsset{
		ContentID:   brandLogoContentID,
		ContentType: "image/png",
		Filename:    "axi-workbench-dango-family.png",
