...
func registerWebControlPlaneRoutes(protected *gin.RouterGroup, proxy gin.HandlerFunc) {
	...
	protected.GET("/control-plane/eps/assets", proxy)
	protected.GET("/control-plane/eps/assets/:assetId", proxy)
	protected.GET("/control-plane/eps/findings", proxy)
	protected.GET("/control-plane/eps/findings/:findingId", proxy)
	protected.GET("/control-plane/eps/runs", proxy)
	protected.GET("/control-plane/eps/runs/:runId", proxy)
	protected.POST("/control-plane/eps/audits", proxy)
	protected.GET("/control-plane/eps/projects/:projectId/summary", proxy)
	protected.GET("/control-plane/eps/runtime", proxy)
